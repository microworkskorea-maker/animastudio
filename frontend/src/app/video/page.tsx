  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="flex justify-end gap-3">
        <button onClick={function() { router.push('/storyboard') }} className="px-5 py-2.5 rounded-xl border border-cream-300 text-sm text-ink-600 hover:bg-cream-100">← 스토리보드</button>
        <button onClick={function() { router.push('/voice') }} className="px-5 py-2.5 rounded-xl bg-forest-600 text-white text-sm font-medium hover:bg-forest-700">더빙 & 자막 →</button>
      </div>
    </div>
  )
}
